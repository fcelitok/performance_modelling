...
def compute_map_metrics(run_output_folder, stage_world_folder):
    ...
    if not path.isfile(last_map_snapshot_path):
        print("compute_map_metrics: last_map_snapshot file not found {}".format(last_map_snapshot_path))
        return

    if not path.isfile(last_map_info_path):
        print("compute_map_metrics: last_map_info file not found {}".format(last_map_info_path))
        return

    if not path.isfile(ground_truth_map_info_file_path):
        print("compute_map_metrics: stage_map_info_file file not found {}".format(ground_truth_map_info_file_path))
        return
